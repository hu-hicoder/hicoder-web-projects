...
const faqs = [
  {
    q: '具体的な活動内容を教えてください。',
    a: '現在は情勢を鑑みて、オンラインのみの活動としています。discordを用いて週に一度通話をする定例会を行っています。',
  },
  {
    q: '初心者でも入会可能ですか？',
    a: 'はい、可能です。定例会で初心者の方に画面共有をしてもらいながらプログラミングを教える会を行って、その後自分の作品を作っている例もあります。興味があればぜひ来てみてください！',
  },
  {
    q: 'コロナ禍以前はどんな活動をしていましたか？',
    a: '工学部のおもしろラボに放課後に集まり、自分の好きな技術について発表し合うLT会を開催したり、呉で行われるプログラミングコンテストにみんなで参加していました。',
  },
  {
    q: '会費はありますか？',
  ...
  {
    q: '見学はできますか？',
    a: '一度discordで定例会に見学に来てみるとよいと思います！ぜひお問い合わせください！',
  },
];
